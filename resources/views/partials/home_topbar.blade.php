        ...
        <div class="flex justify-between items-center h-full">
            <div class="flex items-center md:space-x-4 space-x-2 xl:space-x-0 rtl:space-x-reverse vertical-box">
                <a href="{{ url('/') }}" class="mobile-logo xl:hidden inline-block">
                    <img src="{{ asset('frontend/image/logo-batu.png') }}" class="black_logo" alt="logo">
                    <img src="{{ asset('backend/images/logo-batu.svg') }}" class="white_logo" alt="logo">
                </a>
            ...
            <div class="items-center space-x-4 rtl:space-x-reverse horizental-box">
                <a href="{{ url('/') }}">
                    <span class="xl:inline-block hidden">
                        <img src="{{ asset('frontend/image/logo-batu-dark.png') }}" class="black_logo" alt="logo">
                        <img src="{{ asset('frontend/image/logo-batu-white.png') }}" class="white_logo" alt="logo">
                    </span>
                    <span class="xl:hidden inline-block">
                        <img src="{{ asset('frontend/image/logo-batu.svg') }}" class="black_logo" alt="logo">
                        <img src="{{ asset('frontend/image/logo-batu.svg') }}" class="white_logo"
                            alt="logo">
                    </span>
                </a>
