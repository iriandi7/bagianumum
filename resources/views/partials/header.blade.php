    ...
    <div
        ...
        <div class="flex justify-between items-center h-full">
            <div class="flex items-center md:space-x-4 space-x-2 xl:space-x-0 rtl:space-x-reverse vertical-box">
                <a href="{{ route('home.index') }}" class="mobile-logo xl:hidden inline-block">
            ...
            <div class="nav-tools flex items-center lg:space-x-5 space-x-3 rtl:space-x-reverse leading-0">
                ...
                <div class="relative">
                    <button
                        ...
                        <iconify-icon icon="circle-flags:{{ App::getLocale() }}" class="mr-0 md:mr-2 rtl:ml-2 text-xl">
                        </iconify-icon>
                    </button>
                            ...
                            @foreach (Config::get('languages') as $lang => $language)
                                ...
                                <li>
                                    <a href="{{ route('lang', $lang) }}"
                                        ...
                                        <iconify-icon icon="circle-flags:{{ $lang }}" class="ltr:mr-2 rtl:ml-2 text-xl">
                                        </iconify-icon>
