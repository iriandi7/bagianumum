    ...
    <div class="card">
        <div class="card-body flex flex-col p-6">
            ...
            <div class="card-text h-full ">
                ...
                <form class="space-y-4" method="POST" action="{{ route('admin.galeri.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="input-area relative">
                        ...
                        <textarea id="galeri_desc" name="galeri_desc" rows="5" class="form-control my-editor"
                            placeholder="{{ __('table.enter') }} {{ __('galeri.field.galeri_desc') }}">{!! old('galeri_desc') !!}</textarea>
                        <x-input-error :messages="$errors->get('galeri_desc')" class="mt-2" />
                    </div>
                    <div class="input-area">
                        <label for="galeri_foto" class="form-label">{{ __('galeri.field.galeri_foto') }}
                            <x-required /></label>
